...
shiny_run_mocaredd <- function(...) {
  ...
  ## While waiting for bslib::update_navs() to be included in bslib, not possible to use updateTabsetPanel() in a module.
  ...
  ui <- shiny::tagList(
    ...
    tags$head(
      ...
      tags$script(
        ...
        #   <script async src="https://plausible.io/js/pa-8ulENHu4H88ja5ELIpSNg.js"></script>
        #   <script>
